"""
Agno-native tool for extracting structured property information from property websites.
...
def extract_property_info(
    ...
    """
    Extract structured property information from a property website.
    ...
    Returns:
        Dictionary with extracted property information including property_id
    """
...
# Create Agno Tool
extract_property_info_tool = Tool(
    name="extract_property_info",
    description="Extract structured property information (name, address, phone, email, office hours) from a property website. Creates property record in database and returns property_id.",
    func=extract_property_info,
)

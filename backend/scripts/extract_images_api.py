#!/usr/bin/env python3
"""
API wrapper script for extract_website_images tool.
Called from Next.js API routes via subprocess.

Usage:
    python3 extract_images_api.py <property_id>

Outputs JSON to stdout:
    {"success": true, "images_count": 10}
    or
...
try:
    from tools.extract_website_images import execute

#!/usr/bin/env python3
"""
API wrapper script for find_competitors tool.
Called from Next.js API routes via subprocess.

Usage:
    python3 extract_competitors_api.py <property_id>
...
try:
    from tools.find_competitors import execute
